...
LINKEDIN_NETWORK_FILTER = "voyagerJobsDashJobCards"
...
SESSION = {
    ...
    "page_instance": "urn:li:page:d_flagship3_search_srp_jobs;JAZY0R6vSCePjhIv793OGw==",
...
if __name__ == "__main__":
    print("Fetching GraphQL JOB_DETAILS prefetch...")
    print("⚠️  Update SESSION constants if you get 401 / 403 errors\n")
