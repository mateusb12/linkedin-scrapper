...
export const MOCK_RESUMES = [
    {
        "education": [
            {
                "date": "2019–2023 - Politechnika Lubelska – Intercâmbio acadêmico",
                "degree": "Universidade de Fortaleza Bacharelado em Ciências da Computação ",
                "details": ["Fortaleza, Brazil"]
            }
        ],
        "hard_skills": [
            "Python", "C#", "Javascript", "NextJS", "ReactNative", "React", "SQL", "HTML", "CSS", "Unit tests",
            "Integration tests", "Scrum", "Agile", "Kanban", "Swagger", "AWS", "Google Cloud", "Azure", "Docker",
            "Kubernetes", "TILT", "Github Actions", "Linux", "Flask", "Django", "NodeJS", "Postgres", "Mongo",
            "Supabase", "JWT", "OAuth2", "Github", "Gitlab", "Backend", "Frontend", "Fullstack", "Firebase",
            "Typescript", "GIT", "JSON", "REST", "Desenvolvimento de Software", "DevOps", "CI/CD", "NoSQL",
            "Software Engineering", "Cloud Computing", "Clean Code", "Clean Architecture"
        ],
        "id": 1,
        "name": "Backend python",
        "professional_experience": [
            {
                "title": "Pontotel – Backend Developer(Mar/2025 - Jun/2025)",
                "details": [
            ...
            {
                "title": "Omnichat – Backend Lead(Aug/2024 - Jan/2025)",
                "details": [
            ...
            {
                "title": "Insane Games – Intern(Feb/2024 - Jun/2024)",
                "details": [
...
export const MOCK_JOBS = [
    {
        applicants: 5,
        company: { name: "Innovatech Solutions", logo_url: "https://placehold.co/64x64/3b82f6/ffffff?text=IS" },
        job_url: "#",
        location: "San Francisco, CA",
        posted_on: "2025-07-10T12:00:00Z",
        title: "Senior Frontend Developer",
        urn: "urn:li:job:1",
        workplace_type: "On-site",
        employment_type: "Full-time",
        responsibilities: [
            "Develop new user-facing features for our flagship product.",
            "Build reusable code and libraries for future use.",
            "Ensure the technical feasibility of UI/UX designs.",
            "Optimize application for maximum speed and scalability."
        ],
        qualifications: [
            "5+ years of experience with React and the modern JavaScript ecosystem.",
            "Strong proficiency in JavaScript, TypeScript, HTML5, and CSS3.",
            "Experience with state management libraries like Redux or Zustand.",
            "Familiarity with RESTful APIs and modern authorization mechanisms."
        ],
        keywords: "React,TypeScript,Next.js,JavaScript,CSS,HTML,Frontend,UI,UX",
        easy_apply: true,
        applied_on: null,
        description_full: "Join our dynamic frontend team to build the next generation of user interfaces. You will be a key player in driving the technical direction of our products."
    },
    {
        applicants: 12,
        company: { name: "Auramind.ai", logo_url: "https://placehold.co/64x64/8b5cf6/ffffff?text=A" },
        job_url: "#",
        location: "Goiânia, Brazil (Remote)",
        posted_on: "2025-07-12T12:00:00Z",
        title: "Backend Developer - Python",
        urn: "urn:li:job:2",
        workplace_type: "Remote",
        employment_type: "Full-time",
        responsibilities: [
            "Design and implement scalable and secure RESTful APIs using Python.",
            "Maintain and improve database performance and reliability (PostgreSQL).",
            "Write clean, maintainable, and well-tested code.",
            "Collaborate with frontend developers and product managers to deliver high-quality features."
        ],
        qualifications: [
            "Proven experience as a Python Developer.",
            "Strong experience with Django or Flask frameworks.",
            "Solid understanding of database design, SQL, and ORMs.",
            "Experience with containerization (Docker) and CI/CD pipelines."
        ],
        keywords: "Python,Django,Flask,PostgreSQL,Docker,Backend,RESTful APIs,SQL,CI/CD",
        easy_apply: true,
        applied_on: null,
        description_full: "Auramind.ai is seeking a talented Python Backend Developer to join our fully remote team. You will be responsible for building the core infrastructure that powers our AI-driven platform."
    }
];
...
const fetchWithFallback = async (url, defaultErrorMsg, fallbackData) => {
    try {
        const response = await fetch(url);
        return handleResponse(response, defaultErrorMsg);
    } catch (error) {
        console.warn(`API fetch for ${url} failed, using mock data as fallback.`, error);
...
export const fetchResumeById = async (id) => {
    try {
        ...
        console.warn(`API fetch for resume ${id} failed, using mock data as fallback.`, error);
...
const updateJob = (jobUrn, body) => {
    return fetch(`${API_BASE}/jobs/${jobUrn}`, {
        method: 'PATCH',
