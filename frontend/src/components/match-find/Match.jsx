        ...
        <div className="pt-8">
            ...
            <div className="space-y-6">
                <SectionWrapper title="Summary" icon={<FileText size={20}/>}>
                    <EditableSuggestion id="summary" label="EDITABLE / SUGGESTED" original={baseResume.summary || ''} suggested={adaptedResume.summary || ''} onChange={(e) => handleSimpleChange('summary', e.target.value)} isChanged={true} highlight={true} rows={5} />
                </SectionWrapper>
