        ...
        {activeTab === "past" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6 animate-in fade-in">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="bg-gray-900 rounded p-1 flex space-x-1">
                  {["daily", "weekly", "monthly"].map((t) => (
                    <button
                      key={t}
                      onClick={() => setHistoryPeriod(t)}
                      className={`px-3 py-1 text-xs rounded ${historyPeriod === t ? "bg-blue-600 text-white" : "text-gray-400"}`}
                    >
                      {t}
                    </button>
                  ))}
            ...
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-xl">
              ...
              <div className="h-64">
                <Doughnut
                  data={historyStats.doughnutData}
                  options={{
                    maintainAspectRatio: false,
                    cutout: "70%",
          ...
          <div className="animate-in fade-in">
            <JobFailures
              ...
              pagination={
                failureData
                  ? {
                      page: failureData.page,
                      totalPages: failureData.total_pages,
